    ...
    companion object {
        ...
        fun arrangeLandmarksForFaces(faces: List<Face>): ArrayList<ArrayList<PointF>> {
            ...
            for (face in faces) {
                ...
                val tempFPArray = ArrayList<PointF>()
                ...
                var xMouthLeft: Float = 0.0f
                var yMouthLeft: Float = 0.0f
                var xMouthRight: Float = 0.0f
                var yMouthRight: Float = 0.0f
                var xForeHeadMid: Float = 0.0f
                var yForeHeadMid: Float = 0.0f
                var xForeHeadLeft: Float = 0.0f
                var yForeHeadLeft: Float = 0.0f
                var xForeHeadRight: Float = 0.0f
                var yForeHeadRight: Float = 0.0f
                var xRightEye: Float = 0.0f
                var yRightEye: Float = 0.0f
                var xLeftEye: Float = 0.0f
                var yLeftEye: Float = 0.0f
                ...
                for (landmark in landmarks) {
                    ...
                    tempFPArray.add(PointF(x1, y1)) // Add landmark
                }
                ...
                tempFPArray.add(leftDownMouth)
                tempFPArray.add(rightDownMouth)
                tempFPArray.add(foreHeadMid)
                tempFPArray.add(foreHeadLeft)
                tempFPArray.add(foreHeadRight)
                tempFPArray.add(rightEye)
                tempFPArray.add(leftEye)

                Log.d(TAG, "Total landmarks for face: ${tempFPArray.size}")
                faceLandmarks.add(tempFPArray)
            }
